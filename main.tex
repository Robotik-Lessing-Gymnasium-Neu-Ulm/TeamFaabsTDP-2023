...
\begin{figure}[!h]
    \begin{center}
    \resizebox*{0.4\columnwidth}{!}{\includegraphics{img/prototype.png}}
...
\begin{figure}[!h]
    \begin{center}
    \resizebox*{0.5\columnwidth}{!}{\includegraphics{img/Roboter Home.png}}
...
\begin{figure}[!h]
    \begin{center}
    \resizebox*{0.49\columnwidth}{!}{\includegraphics{img/LidarBaugruppeNormal.png}}
    \caption{lidars}
    \label{lidars}
    \end{center}
    \end{figure}
...
\begin{figure}[!h]
    \begin{center}
    \resizebox*{0.4\columnwidth}{!}{\includegraphics{img/Jetson.png}}
    \caption{Jetson Nano}
    \label{jetson}
    \end{center}
    \end{figure}
...
\begin{figure}[!h]
    \begin{center}
    \resizebox*{0.5\columnwidth}{!}{\includegraphics{img/ballaproach.png}}
    \caption{ballaproach}
    \label{balla}
    \end{center}
    \end{figure}
...
\begin{figure}[!h]
    \begin{center}
    \resizebox*{0.5\columnwidth}{!}{\includegraphics{img/Schuss.png}}
    \caption{kicker}
    \label{kicker}
    \end{center}
    \end{figure}
